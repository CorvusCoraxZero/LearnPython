...
#     '''head = {}
#     head["User-Agent"] = "Mozilla/5.0 (Windows NT 6.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) " \
...
#     req.add_header("User-Agent","Mozilla/5.0 (Windows NT 6.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) "
#                                 "Chrome/69.0.3497.100 Safari/537.36")
#
...
#代理的ip地址
iplist = ['113.214.13.1:1080','211.137.52.158:8080','211.137.52.159:8080','101.200.211.206:8888']

proxy_support = urllib.request.ProxyHandler({'http':random.choice(iplist)})

# 定制创建一个opener
opener = urllib.request.build_opener(proxy_support)
opener.addheaders = [('User-Agent',"Mozilla/5.0 (Windows NT 6.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36")]
